...
package tpdw_danisjiogue.job_chargement_0_1;
...
/**
 * Job: Job_Chargement Purpose: <br>
 * Description: L'execution de ce job permet de charger toutes les tables de SQL SERVER <br>
 * @author user@talend.com
 * @version 7.1.1.20181026_1147
 * @status 
 */
public class Job_Chargement implements TalendJob {
	...
	private final String jobName = "Job_Chargement";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					Job_Chargement.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass()
						...
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(Job_Chargement.this, new Object[] { e,
	...
	public void tRunJob_1Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				tpdw_danisjiogue.job_danisjiogue_0_1.Job_DanisJIOGUE childJob_tRunJob_1 = new tpdw_danisjiogue.job_danisjiogue_0_1.Job_DanisJIOGUE();
				// pass DataSources
	...
	public void tRunJob_2Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				tpdw_danisjiogue.job_table_dep1_0_1.job_table_dep1 childJob_tRunJob_2 = new tpdw_danisjiogue.job_table_dep1_0_1.job_table_dep1();
				// pass DataSources
	...
	public void tRunJob_3Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				tpdw_danisjiogue.job_table_dep2_0_1.job_table_dep2 childJob_tRunJob_3 = new tpdw_danisjiogue.job_table_dep2_0_1.job_table_dep2();
				// pass DataSources
	...
	public static void main(String[] args) {
		final Job_Chargement Job_ChargementClass = new Job_Chargement();

		int exitCode = Job_ChargementClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = Job_Chargement.class
					.getClassLoader().getResourceAsStream(
							"tpdw_danisjiogue/job_chargement_0_1/contexts/"
									+ contextStr + ".properties");
			if (inContext == null) {
				inContext = Job_Chargement.class
						.getClassLoader()
						.getResourceAsStream(
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory)
					+ " bytes memory increase when running : Job_Chargement");
		}
...
/************************************************************************************************
 * 40982 characters generated by Talend Open Studio for Data Integration on the
 * 23 mars 2020 10:01:15 GMT
 ************************************************************************************************/
